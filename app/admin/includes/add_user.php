...
if (isset($_POST['create_user'])) {
    ...
    $stmt = $connection->prepare("INSERT INTO users (username,user_password,user_firstname,user_lastname,user_email,user_role,user_image) VALUES(?,?,?,?,?,?,?)");
    $stmt->bind_param("sssssss", $username, $user_password, $user_firstname, $user_lastname, $user_email, $user_role, $user_image);
    $stmt->execute();
    $stmt->close();
